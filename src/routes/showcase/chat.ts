...
import { canUseLocalChatStorage } from "$lib/ai-chat/core/storage.js";
...
export function createShowcaseChatSessionIfAvailable() {
	if (!canUseLocalChatStorage()) {
		return null;
	}

	return createShowcaseChatSession();
}
